    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="custom-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">CÀ PHÊ</li>
            </ol>
        </nav>
        <h4 class="text-uppercase fs-1">CÀ PHÊ</h4>
        <hr>
    </div>
</section>
...
<div class="main-container1">
    ...
    <aside class="sidebar">
        ...
        <form action="CaPhe.php" method="POST">
            <label for="categories">Theo Danh mục:</label>
            <div class="form-check mb-2">
                <input type="radio" value="CaPheNong" class="form-check-input" name="category" id="category_one">
                <label class="form-check-label" for="category_one">Nóng</label>
            </div>
            <div class="form-check">
                <input type="radio" value="CaPheLanh" class="form-check-input" name="category" id="category_two">
                <label class="form-check-label" for="category_two">Lạnh</label>
            </div>
            <hr>
    ...
    <ul class="my-pagination1">
        <?php if ($page > 1): ?>
            <li class="my-page-item">
                <a href="CaPhe.php?page=<?= $page - 1; ?>" class="my-page-link"><<</a>
            </li>
        <?php endif; ?>
        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
            <li class="my-page-item <?= $i == $page ? 'active' : ''; ?>">
                <a href="CaPhe.php?page=<?= $i; ?>" class="my-page-link"><?= $i; ?></a>
            </li>
        <?php endfor; ?>
