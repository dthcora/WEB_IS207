...
<section id="featured" class="my-5 py-5 text-center">
    <div class="container">
        ...
        <h4 class="text-uppercase fs-1">TRÀ</h4>
        <hr>
    </div>
</section>
    ...
    <aside class="sidebar">
        ...
        <form action="Tra.php" method="POST">
            ...
            <div class="form-check mb-2">
                <input type="radio" value="TraTraiCay" class="form-check-input" name="category" id="category_one">
                <label class="form-check-label" for="category_one">Trái cây</label>
            </div>
            <div class="form-check">
                <input type="radio" value="TraSua" class="form-check-input" name="category" id="category_two">
                <label class="form-check-label" for="category_two">Trà sữa</label>
            </div>
            <hr>
    ...
    <ul class="my-pagination1">
        <?php if ($page > 1): ?>
            <li class="my-page-item">
                <a href="Tra.php?page=<?= $page - 1; ?>" class="my-page-link"><<</a>
            </li>
        <?php endif; ?>
        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
            <li class="my-page-item <?= $i == $page ? 'active' : ''; ?>">
                <a href="Tra.php?page=<?= $i; ?>" class="my-page-link"><?= $i; ?></a>
            </li>
        <?php endfor; ?>
