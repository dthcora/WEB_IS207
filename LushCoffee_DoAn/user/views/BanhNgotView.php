    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="custom-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="../public/Banh.php">BÁNH</a></li>
                <li class="breadcrumb-item active" aria-current="page">BÁNH NGỌT</li>
            </ol>
        </nav>
        <h4 class="text-uppercase fs-1">BÁNH NGỌT</h4>
        <hr>
    </div>
</section>
...
<div class="main-container1">
    ...
    <aside class="sidebar">
        ...
        <form action="BanhNgot.php" method="POST">
    ...
    <ul class="my-pagination1">
        <?php if ($page > 1): ?>
            <li class="my-page-item">
                <a href="BanhNgot.php?page=<?= $page - 1; ?>" class="my-page-link"><<</a>
            </li>
        <?php endif; ?>
        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
            <li class="my-page-item <?= $i == $page ? 'active' : ''; ?>">
                <a href="BanhNgot.php?page=<?= $i; ?>" class="my-page-link"><?= $i; ?></a>
            </li>
        <?php endfor; ?>
